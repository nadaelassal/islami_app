        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color:settingsProvider.isDark? AppTheme.gold : Color.fromRGBO(183, 147, 95, 1).withOpacity(.57),
            ),
            child: Text(
              counter.toString(),
              style: TextStyle(
          ...
          Container(
            ...
            decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(30),
                color:settingsProvider.isDark? AppTheme.gold : Theme.of(context).primaryColor),
            child: Text(
              doaa[index].toString(),
              style: TextStyle(
                  fontSize: 25,
